...
namespace CompetitionClient
{
    public partial class ChildEnrollmentPage : Form
    {
        ...
        {
            tableNumberChildrenPerRound.BeginInvoke(new UpdateTableCallback(addDataToTable));
        }
        ...
        private void enrollButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    long numberEnrollments = controller.FindNumberOfEnrollments(firstname, lastname);
