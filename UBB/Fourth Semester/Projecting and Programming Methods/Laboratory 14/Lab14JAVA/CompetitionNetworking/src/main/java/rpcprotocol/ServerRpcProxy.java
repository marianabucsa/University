...
public class ServerRpcProxy implements ServerInterface {
    ...
    @Override
    public User login(String username, String password, INotificationService client) throws Exception {
    ...
    public void logout(User user, INotificationService client) throws Exception {
    ...
    private void handleUpdate(Response response) {
        ...
        if (response.type()== ResponseType.SAVE_ENROLLMENT){
           Enrollment enrollment=(Enrollment)response.data();
            try {
                client.addedEnrollment(enrollment);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
